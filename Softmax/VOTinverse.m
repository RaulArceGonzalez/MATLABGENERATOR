    function VOTinverse(layers_fc,input_size, n_enteros, n_decimales)
    name = sprintf('CNN_Network/Softmax/VOT_inverse.vhd');
    fid = fopen(name, 'wt');
    ...
    fprintf(fid, '\n');
    fprintf(fid, 'entity VOT_inverse is\n');
    fprintf(fid, '\tPort ( \n'); 
    for b = 1 : 3
    ...
    fprintf(fid, 'end VOT_inverse;\n');
    fprintf(fid, '\n');
    fprintf(fid, 'architecture Behavioral of VOT_inverse is\n');
    fprintf(fid, '\n');
    fprintf(fid, 'Begin\n');
