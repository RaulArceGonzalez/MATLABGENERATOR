...
fprintf(fileID, 'Port ( \n');
        for a = 1 : 3
        fprintf(fileID, '\t\t serial_out_%d : in STD_LOGIC;\n',a);
        end
        fprintf(fileID, '\t\t serial_out_v : out STD_LOGIC);\n');
 fprintf(fileID, 'end VOT_PAR2SER; \n');
fprintf(fileID, 'architecture Behavioral of VOT_PAR2SER is\n');
fprintf(fileID, 'begin \n\n');
    fprintf(fileID, 'serial_out_v <= (serial_out_1 and serial_out_2) or (serial_out_1 and serial_out_3) or (serial_out_2 and serial_out_3);\n');
